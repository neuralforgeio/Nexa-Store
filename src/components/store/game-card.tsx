    ...
    return (
      ...
      >
        <RouteLink
          ...
          className="group flex w-32 flex-col items-center gap-2.5 rounded-xl border bg-card px-3 py-4 text-center shadow-card transition-[border-color,box-shadow,transform] duration-200 hover:-translate-y-1 hover:border-primary/45 hover:shadow-card-hover focus-visible:outline-2 focus-visible:outline-offset-2 sm:w-36"
        ...
        >
          ...
          <span>
            ...
            <span className="mt-0.5 block text-[11px] text-muted-foreground">{count}</span>
          </span>
        </RouteLink>
      </motion.div>
    );
